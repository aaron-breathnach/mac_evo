...
make_figure_5a <- function(gen_pos, p_adj) {
...
make_figure_5c <- function(gen_pos, amr_gen) {
...
make_figure_5 <- function() {
  ...
  p1 <- make_figure_5a(gen_pos, "bonferroni")
  ...
  p3 <- make_figure_5c(gen_pos, amr_gen)
  ...
  ggsave("plots/figure_5.png", p, width = 10, height = 10, bg = "white")
